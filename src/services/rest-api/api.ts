...
export const UploadControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        uploadUsingPOST: async (files: Array<any>, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'files' is not null or undefined
            assertParamExists('uploadUsingPOST', 'files', files)
            const localVarPath = `/kathanor-api/upload/upload`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const UploadControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async uploadUsingPOST(files: Array<any>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.uploadUsingPOST(files, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const UploadControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        uploadUsingPOST(files: Array<any>, options?: any): AxiosPromise<void> {
            return localVarFp.uploadUsingPOST(files, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class UploadControllerApi extends BaseAPI {
     ...
     */
    public uploadUsingPOST(files: Array<any>, options?: any) {
        return UploadControllerApiFp(this.configuration).uploadUsingPOST(files, options).then((request) => request(this.axios, this.basePath));
    }
}
